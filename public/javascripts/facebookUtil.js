...
var FacebookUtil = (function () {
    ...
    FacebookUtil.prototype.indexLogin = function () {
    ...
    FacebookUtil.prototype.gameLogin = function (game) {
    ...
    FacebookUtil.prototype.getUserName = function (game) {
        var name;
    ...
    FacebookUtil.prototype.getUserData = function () {
    ...
    FacebookUtil.prototype.shareScore = function (score) {
        FB.ui({
            method: 'feed',
            name: 'WhackAFire',
