...
var gameStates;
(function (gameStates) {
    gameStates[gameStates["menu"] = 0] = "menu";
    gameStates[gameStates["ingame"] = 1] = "ingame";
    gameStates[gameStates["endgame"] = 2] = "endgame";
})(gameStates || (gameStates = {}));
var gameSelfRef;
var Game = (function () {
    function Game() {
        this.instructionsStyle = { font: "15px Arial", fill: "#ffffff", align: "center" };
        this.instructionsText = "As more and more forest fires continue to burn, we need your help to put some out! click on a fire 5 times to extinguish it! GOOD LUCK!";
        // Names for all visual components loaded
        this.startButtonName = 'startButton';
        this.loadingButtonName = 'loadButton';
        this.highScoreButtonName = 'highScoreButton';
        this.splashScreenName = 'splashScreen';
        this.mapName = 'map';
        this.endTableBackgroundName = 'bg';
        this.presentsName = 'presents';
        this.titleName = 'whack-a-fire';
        this.shareButtonName = 'shareButton';
        this.restartButtonName = 'restartButton';
        this.creditsButtonName = 'creditsButton';
        this.closeButtonName = 'closeButton';
        // All asset locations
        this.startButtonSpritesheet = 'assets/images/startButtonSpritesheet.jpg';
        this.startButtonJSON = 'assets/JSON/startButtonSpritesheet.json';
        this.loadingButtonImg = 'assets/images/loadingButton.jpg';
        this.highScoreButtonSpritesheet = 'assets/images/highScoreButtonSpriteSheet.png';
        this.highScoreButtonJSON = 'assets/JSON/highScoreButtonSpriteSheet.json';
        this.splashScreenImg = 'assets/images/splashScreen.png';
        this.mapImg = 'assets/images/map.jpg';
        this.endTableBackgroundImg = 'assets/images/skyblue.png';
        this.presentsImg = 'assets/images/presents.png';
        this.titleImg = 'assets/images/whack-a-fire.png';
        this.shareButtonImg = 'assets/images/ShareScore.png';
        this.restartButtonImg = 'assets/images/RestartGame.png';
        this.creditsButtonImg = 'assets/images/creditsButton.png';
        this.closeButtonImg = 'assets/images/CloseButton.png';
        this.ashleyImg = 'assets/images/ashley.png';
        this.ibsImg = 'assets/images/ibs.png';
        this.kyleImg = 'assets/images/kyle.png';
        this.zachImg = 'assets/images/zach.png';
        //Components x, y, width, height, and scales (if needed)
        this.splashScreenX = 50;
        this.splashScreenY = 0;
        this.splashScreenWidth = 539;
        this.splashScreenHeight = 132;
        this.presentsX = 180;
        this.presentsY = 150;
        this.presentsWidth = 250;
        this.presentsHeight = 50;
        this.titlePageFireX = 260;
        this.titlePageFireY = 200;
        this.titlePageFireScaleX = 0.2;
        this.titlePageFireScaleY = 0.2;
        this.whackAFireTitleX = 160;
        this.whackAFireTitleY = 340;
        this.whackAFireTitleWidth = 250;
        this.whackAFireTitleHeight = 50;
        this.instructionsX = 60;
        this.instructionsY = 440;
        this.instructionsLength = 520;
        this.startButtonX = 375;
        this.startButtonY = 550;
        this.creditsButtonX = 585;
        this.creditsButtonY = 610;
        this.closeButtonX = 0;
        this.closeButtonY = 0;
        this.highScoreButtonX = 155;
        this.highScoreButtonY = 550;
        this.shareButtonX = 110;
        this.shareButtonY = 535;
        this.restartButtonX = 350;
        this.restartButtonY = 535;
        this.mapX = 0;
        this.mapY = 0;
        this.mapWidth = 640;
        this.mapHeight = 640;
        this.splashVideoLength = 4184;
        this.latPerPixel = .0071875;
        this.latOfOrigin = 54.1;
        this.longPerPixel = .0109375;
        this.longOfOrigin = -127.5;
        this.numFiresToStart = 5;
        globalTestGame = this;
        gameSelfRef = this;
        gameSelfRef.fireDataList = new Array();
        gameSelfRef.fires = new Array();
        var width = 640;
        var height = 640;
    ...
    Game.prototype.preload = function () {
        ...
        this.game.load.atlas(gameSelfRef.highScoreButtonName, gameSelfRef.highScoreButtonSpritesheet, gameSelfRef.highScoreButtonJSON);
    ...
    Game.prototype.preloadVideos = function () {
    ...
    Game.prototype.create = function () {
        ...
        this.splashScreen = this.game.add.tileSprite(gameSelfRef.splashScreenX, gameSelfRef.splashScreenY, gameSelfRef.splashScreenWidth, gameSelfRef.splashScreenHeight, gameSelfRef.splashScreenName);
        // create "presents" object
        this.presents = this.game.add.tileSprite(gameSelfRef.presentsX, gameSelfRef.presentsY, gameSelfRef.presentsWidth, gameSelfRef.presentsHeight, gameSelfRef.presentsName);
        // create fire object for title page
        this.titlePageFire = this.game.add.sprite(gameSelfRef.titlePageFireX, gameSelfRef.titlePageFireY, gameSelfRef.fireOverlay.spriteName);
        ...
        this.whackAFireTitle = this.game.add.tileSprite(gameSelfRef.whackAFireTitleX, gameSelfRef.whackAFireTitleY, gameSelfRef.whackAFireTitleWidth, gameSelfRef.whackAFireTitleHeight, gameSelfRef.titleName);
        // create instructions object
        this.instructions = this.game.add.text(gameSelfRef.instructionsX, gameSelfRef.instructionsY, gameSelfRef.instructionsText, gameSelfRef.instructionsStyle);
        ...
        gameSelfRef.startButton = gameSelfRef.game.add.button(gameSelfRef.startButtonX, gameSelfRef.startButtonY, gameSelfRef.startButtonName, startStandard, this, onStartButtonDownImg, onStartButtonUpImg);
        ...
        gameSelfRef.highScoreButton = gameSelfRef.game.add.button(gameSelfRef.highScoreButtonX, gameSelfRef.highScoreButtonY, gameSelfRef.highScoreButtonName, displayScores, gameSelfRef.highScoreBoard, onHighScoreButtonDownImg, onHighScoreButtonUpImg);
        ...
        // create map object
        gameSelfRef.map = this.game.add.tileSprite(gameSelfRef.mapX, gameSelfRef.mapY, gameSelfRef.mapWidth, gameSelfRef.mapHeight, gameSelfRef.mapName);
    ...
    Game.prototype.highScoresClicked = function (callback) {
    ...
    Game.prototype.playSplashVideo = function () {
    ...
    Game.prototype.triggerThemeMusic = function () {
        this.themeTrack.play();
        this.themeTrack.volume = 0.6;
    };
    Game.prototype.checkLoading = function () {
    ...
    Game.prototype.checkUserLoading = function () {
    ...
    Game.prototype.serverQuery_LoadFireData = function () {
        var clientSocket = io();
    ...
    Game.prototype.serverQuery_UserLogin = function () {
    ...
    Game.prototype.sendTestRequest = function () {
        var clientSocket = io();
    ...
    Game.prototype.randomizeFires = function (fires) {
    ...
    Game.prototype.unpause = function (event) {
        if (gameSelfRef.gameState == gameStates.endgame) {
            ...
            var fbx1 = 110, fbx2 = 290, fby1 = 535, fby2 = 615;
            // set edges of restart button
            var restartx1 = 350, restartx2 = 530, restarty1 = 535, restarty2 = 615;
    ...
    Game.prototype.showFireData = function () {
    ...
    Game.prototype.saveUserScore = function () {
        var clientSocket = io();
    ...
    Game.prototype.findLat = function (clickedFireName) {
    ...
    Game.prototype.findLong = function (clickedFireName) {
...
var WhackAFireInstance = (function () {
    function WhackAFireInstance(game, sk, timer, overlay) {
    ...
    WhackAFireInstance.prototype.initLevelVideos = function () {
        if (whackAFireSelfRef.game.game == null)
            return; //developer note: this line is for unit test support 
    ...
    WhackAFireInstance.prototype.initNewGame = function () {
        whackAFireSelfRef.level = 0;
        whackAFireSelfRef.incrementLevel();
    };
    WhackAFireInstance.prototype.postName = function (name) {
    ...
    WhackAFireInstance.prototype.postScore = function (score) {
    };
    WhackAFireInstance.prototype.incrementLevel = function () {
    ...
    WhackAFireInstance.prototype.playLevelVideo = function () {
    ...
    WhackAFireInstance.prototype.beginGameplay = function () {
        whackAFireSelfRef.timer.setPaused(false);
    };
    WhackAFireInstance.prototype.postGameOver = function () {
    };
    WhackAFireInstance.prototype.getMaxCount = function () {
        return whackAFireSelfRef.maxCount;
    };
    return WhackAFireInstance;
})();
var testGame;
